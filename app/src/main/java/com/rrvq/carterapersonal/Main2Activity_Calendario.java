...
public class Main2Activity_Calendario extends AppCompatActivity {
    ...
    public void setSpinnerMes() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.spinner_seleccion, meses);
    ...
    public void setSpinnerAno() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.spinner_seleccion, anos);
        // ahora hay que asignar al spiner el opjeto adapter que cremos en la linea de arriba
    ...
    private void initVistas() {
        ExpandableListView listaExp = (ExpandableListView) this.findViewById(R.id.ViewlistaExpandible);
...
//                                if (getDate().charAt(3) == fe.charAt(3) && getDate().charAt(4) == fe.charAt(4)) {
            ...
            tv_ingresoTotal.setText(getResources().getString(R.string.ingresoT) + " " + tipo_moneda + " " + formato.format(totalIngreso));
        }
...
//                                if (getDate().charAt(3) == fe.charAt(3) && getDate().charAt(4) == fe.charAt(4)) {
        ...
        if (g.moveToFirst()) {
            ...
            // muestro el total del gasto
            tv_gastoTotal.setText(getResources().getString(R.string.gastototal) + " " + tipo_moneda + " " + formato.format(totalGasto));
        }
