...
public class Main2Activity_Cuentas extends AppCompatActivity implements View.OnClickListener {
    ...
    public void castin_view() {
        ...
        castintvCuentas = new TextView[]{
                (TextView) findViewById(R.id.tv1), (TextView) findViewById(R.id.tv2),
                (TextView) findViewById(R.id.tv3), (TextView) findViewById(R.id.tv4)};
    }
    ...
    public void btnAddCuentas(View vista) {
        ...
        // solo 2 para que mande a comprar
        if (countGastos < 2) {
            baseDeDatos.close();
