...
public class Main2Activity_Transferencia_edit extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fila.moveToFirst()) {
            ...
            tv_monto.setText(String.valueOf(formato.format(monto_T)));
    ...
    public void castin_view() {
        ...
        spinner1 = (Spinner) findViewById(R.id.view_spinner1);
        spinner2 = (Spinner) findViewById(R.id.view_spinner2);
        ...
        btn_mostrar = (ImageButton) findViewById(R.id.btn_mostrar);

        btn_container = (ConstraintLayout) findViewById(R.id.btn_container);

        //Castin de la calculadora
        castinCalculadora = new Button[]{
                (Button) findViewById(R.id.btn_uno), (Button) findViewById(R.id.btn_dos),
                (Button) findViewById(R.id.btn_tres), (Button) findViewById(R.id.btn_cuatro),
                (Button) findViewById(R.id.btn_cinco), (Button) findViewById(R.id.btn_seis),
                (Button) findViewById(R.id.btn_siete), (Button) findViewById(R.id.btn_ocho),
                (Button) findViewById(R.id.btn_nueve), (Button) findViewById(R.id.btn_cero),
                (Button) findViewById(R.id.btn_mas), (Button) findViewById(R.id.btn_menos),
                (Button) findViewById(R.id.btn_por), (Button) findViewById(R.id.btn_entre),
                (Button) findViewById(R.id.btn_punto), (Button) findViewById(R.id.btn_igual)};
    }
...
//                    ACTUALIZAMOS LOS VALORES DE LA TABLA DE GASTOS
    ...
    public void spinnerDesde() {
        ...
        if (desde_T == 0) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.spinner_seleccion, opciones);
