...
public class Main2Activity_Categorias_edit extends AppCompatActivity implements View.OnClickListener {
    ...
    public void castin_view() {
        ...
        iv_seleccionada = (ImageView) findViewById(R.id.iv_selecionada);
        et_nombre = (EditText) findViewById(R.id.et_nombre_categoria);
        ...
        castinBtn = new ImageButton[]{
                ...
                (ImageButton) findViewById(R.id.btn_img_17), (ImageButton) findViewById(R.id.btn_img_18),
                (ImageButton) findViewById(R.id.btn_img_19), (ImageButton) findViewById(R.id.btn_img_20),
                (ImageButton) findViewById(R.id.btn_img_21), (ImageButton) findViewById(R.id.btn_img_22),
                (ImageButton) findViewById(R.id.btn_img_23), (ImageButton) findViewById(R.id.btn_img_24),
                (ImageButton) findViewById(R.id.btn_img_25), (ImageButton) findViewById(R.id.btn_img_26),
                (ImageButton) findViewById(R.id.btn_img_27), (ImageButton) findViewById(R.id.btn_img_28),
                (ImageButton) findViewById(R.id.btn_img_29), (ImageButton) findViewById(R.id.btn_img_30),
                (ImageButton) findViewById(R.id.btn_img_31), (ImageButton) findViewById(R.id.btn_img_32),
                (ImageButton) findViewById(R.id.btn_img_33), (ImageButton) findViewById(R.id.btn_img_34),
                (ImageButton) findViewById(R.id.btn_img_35), (ImageButton) findViewById(R.id.btn_img_36),
                (ImageButton) findViewById(R.id.btn_img_37), (ImageButton) findViewById(R.id.btn_img_38),
                (ImageButton) findViewById(R.id.btn_img_39), (ImageButton) findViewById(R.id.btn_img_40),
                (ImageButton) findViewById(R.id.btn_img_41), (ImageButton) findViewById(R.id.btn_img_42),
                (ImageButton) findViewById(R.id.btn_img_43), (ImageButton) findViewById(R.id.btn_img_44),
                (ImageButton) findViewById(R.id.btn_img_45), (ImageButton) findViewById(R.id.btn_img_46),
                (ImageButton) findViewById(R.id.btn_img_47), (ImageButton) findViewById(R.id.btn_img_48),
                (ImageButton) findViewById(R.id.btn_img_49), (ImageButton) findViewById(R.id.btn_img_50),
                (ImageButton) findViewById(R.id.btn_img_51), (ImageButton) findViewById(R.id.btn_img_52),
                (ImageButton) findViewById(R.id.btn_img_53), (ImageButton) findViewById(R.id.btn_img_54),
                (ImageButton) findViewById(R.id.btn_img_55), (ImageButton) findViewById(R.id.btn_img_56),
                (ImageButton) findViewById(R.id.btn_img_57), (ImageButton) findViewById(R.id.btn_img_58),
                (ImageButton) findViewById(R.id.btn_img_59), (ImageButton) findViewById(R.id.btn_img_60),
                (ImageButton) findViewById(R.id.btn_img_61), (ImageButton) findViewById(R.id.btn_img_62),
                (ImageButton) findViewById(R.id.btn_img_63), (ImageButton) findViewById(R.id.btn_img_64),
                (ImageButton) findViewById(R.id.btn_img_65), (ImageButton) findViewById(R.id.btn_img_66),
                (ImageButton) findViewById(R.id.btn_img_67), (ImageButton) findViewById(R.id.btn_img_68),
                (ImageButton) findViewById(R.id.btn_img_69), (ImageButton) findViewById(R.id.btn_img_70),
                (ImageButton) findViewById(R.id.btn_img_71), (ImageButton) findViewById(R.id.btn_img_72),
                (ImageButton) findViewById(R.id.btn_img_73), (ImageButton) findViewById(R.id.btn_img_74),
                (ImageButton) findViewById(R.id.btn_img_75), (ImageButton) findViewById(R.id.btn_img_76),
                (ImageButton) findViewById(R.id.btn_img_77), (ImageButton) findViewById(R.id.btn_img_78),
                (ImageButton) findViewById(R.id.btn_img_79), (ImageButton) findViewById(R.id.btn_img_80)};
    }
                        ...
                        case "gasto":
                            ...
                            if (count > 1) {
                                ...
                                if (fila.moveToFirst()) {
                                    ...
                                    int rowfilaCuenta = 0, rowgCuenta = 0;
                                    do {
    ...
    public void onClick(View v) {
        ...
        switch (dato) {
            case "gasto":
                ...
                Siguiente = new Intent(this, Main2Activity_PRO.class);
                startActivity(Siguiente);
                break;
            case "ingreso":
                /*for (int i = 0; i < imgGastosIngresos.length; i++) {
